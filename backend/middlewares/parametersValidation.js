...
// Validações da atualização de parâmetros
const parameterUpdateValidation = () => {
    return [
        // Validação do id do parâmetro
        body("id")
            .isMongoId()
            .withMessage("Parâmetros inválidos."),
        // Validação do id do dispositivo
        body("deviceId")
            .isMongoId()
            .withMessage("Dispositivo inválido."),
